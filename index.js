...
mongoose.connect("mongodb+srv://steveyamada66:eUmSX4NL1f4xOU08@cluster0.xwkb9vh.mongodb.net/blogUserDatabase?retryWrites=true&w=majority")
    .then(() => {
        console.log("Success: Connected to MongoDB")
    })
    .catch((error) => {
        console.log("Failer: Unconnected to MongoDB")
})
